...
define("AX_TIMER_START", microtime (true));//记录请求开始时间
    ...
    $PAGE_TITLE       = AXAPI_PROJECT_TITLE;
    $PAGE_KEYWORDS    = $PAGE_TITLE;
    $PAGE_DESCRIPTION = $PAGE_TITLE;
    $PAGE_ICON        = W2Web::getCurrentHost().'/images/logo.png';

    $currentUserResult = Utility::getCurrentUserResult();

    if (!is_object($currentUserResult))
    {
        include AXAPI_ELO_PATH . '/union_login.php';
    }
    ...
    {
        include AXAPI_ROOT_PATH . '/../dist/index.html';
    }
